...
void TestReadInteraction::TestReadClient(nlTestSuite * apSuite, void * apContext)
{
    ...
    err                                  = readClient.Init(&chip::gExchangeManager, nullptr);
    NL_TEST_ASSERT(apSuite, err == CHIP_NO_ERROR);

    err = readClient.SendReadRequest(chip::kTestDeviceNodeId, chip::gAdminId);
...
void TestReadInteraction::TestReadHandler(nlTestSuite * apSuite, void * apContext)
{
    ...
    readHandler.Init(&chip::gExchangeManager, nullptr);
